...
</code></pre><p>If you are unsure, refer to this <a href="https://yourbasic.org/golang/format-parse-string-time-date-example/">guide</a>. </p></td></tr><tr><td><code>createAllColumnsIfAvailable</code></td><td>Y</td><td>This is a boolean field. <br><br>If this is set <code>true</code>, it will automatically create columns even if the value is <code>NULL</code>.</td></tr></tbody></table>
