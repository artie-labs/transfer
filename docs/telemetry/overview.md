...
| --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- | ------------------------------------------------------------------------------------------------- |
| `transfer.ingestion.lag.95percentile`   | <p>p95 of time lag from Kafka message was published and received.<br><br>Since Transfer <code>1.4.6</code></p>                                                                              | `ms`  | <ul><li><code>groupid</code></li><li><code>topic</code></li><li><code>partition</code></li></ul>  |
| `transfer.ingestion.lag.avg`            | <p>Avg of time lag from Kafka message was published and received.<br><br>Since Transfer <code>1.4.6</code><br><br>If self-hosting Transfer, this is a good metric to set a monitor for.</p> | `ms`  | <ul><li><code>groupid</code> </li><li><code>topic</code></li><li><code>partition</code></li></ul> |
| `transfer.ingestion.lag.max`            | <p>max lag from Kafka message was published and received.<br><br>Since Transfer <code>1.4.6</code></p>                                                                                      | `ms`  | <ul><li><code>groupid</code></li><li><code>topic</code></li><li><code>partition</code></li></ul>  |
