    ...
    expected_rows = [
        {
            ...
            'created_at': datetime.fromisoformat("2024-03-20 06:00:00.111") if location else datetime.fromisoformat("2024-03-20 06:00:00.111").replace(tzinfo=timezone.utc),
            'updated_at': datetime.fromisoformat("2024-03-20 06:00:00.111") if location else datetime.fromisoformat("2024-03-20 06:00:00.111").replace(tzinfo=timezone.utc),
        ...
        },
        {
            ...
            'created_at': datetime.fromisoformat("2024-03-20 07:00:00.555") if location else datetime.fromisoformat("2024-03-20 07:00:00.555").replace(tzinfo=timezone.utc),
            'updated_at': datetime.fromisoformat("2024-03-20 07:00:00.444") if location else datetime.fromisoformat("2024-03-20 07:00:00.444").replace(tzinfo=timezone.utc),
        ...
        },
        {
            ...
            'created_at': datetime.fromisoformat("1969-12-31 19:00:00.000") if location else datetime.fromisoformat("1969-12-31 19:00:00.000").replace(tzinfo=timezone.utc),
            'updated_at': datetime.fromisoformat("2099-12-31 18:59:59.999") if location else datetime.fromisoformat("2099-12-31 18:59:59.999").replace(tzinfo=timezone.utc),
        ...
        },
        {
            ...
            'created_at': datetime.fromisoformat("2024-02-29 07:00:00.123") if location else datetime.fromisoformat("2024-02-29 07:00:00.123").replace(tzinfo=timezone.utc),
            'updated_at': datetime.fromisoformat("2024-02-29 07:00:00.123") if location else datetime.fromisoformat("2024-02-29 07:00:00.123").replace(tzinfo=timezone.utc),
        ...
        },
        {
            ...
            'created_at': datetime.fromisoformat("2024-12-31 18:59:59.999") if location else datetime.fromisoformat("2024-12-31 18:59:59.999").replace(tzinfo=timezone.utc),
            'updated_at': datetime.fromisoformat("2024-12-31 18:59:59.999") if location else datetime.fromisoformat("2024-12-31 18:59:59.999").replace(tzinfo=timezone.utc),
