...
func (d DatabricksDialect) BuildCopyIntoQuery(tempTableID sql.TableIdentifier, colNames []string, columns []string, filePath string) string {
...
FORMAT_OPTIONS (
    ...
    'lineSep' = '\n'
		...
		// COPY INTO
		tempTableID.FullyQualifiedName(), strings.Join(colNames, ", "),
