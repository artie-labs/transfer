...
func (s *SnowflakeTestSuite) TestExecuteMergeNilEdgeCase() {
	...
	s.stageStore.configMap.AddTableToConfig(s.stageStore.ToFullyQualifiedName(tableData, true),
...
func (s *SnowflakeTestSuite) TestExecuteMergeReestablishAuth() {
	...
	s.stageStore.configMap.AddTableToConfig(s.stageStore.ToFullyQualifiedName(tableData, true), types.NewDwhTableConfig(&cols, nil, false, true))
...
func (s *SnowflakeTestSuite) TestExecuteMerge() {
	...
	fqName := s.stageStore.ToFullyQualifiedName(tableData, true)
...
func (s *SnowflakeTestSuite) TestExecuteMergeDeletionFlagRemoval() {
	...
	s.stageStore.configMap.AddTableToConfig(s.stageStore.ToFullyQualifiedName(tableData, true), _config)
	...
	assert.Equal(s.T(), len(s.stageStore.configMap.TableConfig(s.stageStore.ToFullyQualifiedName(tableData, true)).ReadOnlyColumnsToDelete()), 1,
		s.stageStore.configMap.TableConfig(s.stageStore.ToFullyQualifiedName(tableData, true)).ReadOnlyColumnsToDelete())

	_, isOk := s.stageStore.configMap.TableConfig(s.stageStore.ToFullyQualifiedName(tableData, true)).ReadOnlyColumnsToDelete()["new"]
	assert.True(s.T(), isOk)
	...
	assert.Equal(s.T(), len(s.stageStore.configMap.TableConfig(s.stageStore.ToFullyQualifiedName(tableData, true)).ReadOnlyColumnsToDelete()), 0,
		s.stageStore.configMap.TableConfig(s.stageStore.ToFullyQualifiedName(tableData, true)).ReadOnlyColumnsToDelete())
}
