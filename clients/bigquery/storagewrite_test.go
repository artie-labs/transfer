...
func TestRowToMessage(t *testing.T) {
	...
	row := map[string]any{
		...
		"c_numeric":        decimal.NewDecimal(decimal.PrecisionNotSpecified, numbers.MustParseDecimal("3.14159")),
		"c_string":         "foo bar",
		"c_string_decimal": decimal.NewDecimal(decimal.PrecisionNotSpecified, numbers.MustParseDecimal("1.61803")),
