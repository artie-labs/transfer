...
func (ti TableIdentifier) Catalog() string {
	return ti.catalog
}
...
func (ti TableIdentifier) FullyQualifiedName() string {
	return fmt.Sprintf("%s.%s.%s", _dialect.QuoteIdentifier(ti.catalog), _dialect.QuoteIdentifier(ti.namespace), _dialect.QuoteIdentifier(ti.table))
}
