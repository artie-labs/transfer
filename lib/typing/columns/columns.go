...
func ColumnsUpdateQuery(columns []string, columnsToTypes Columns, destKind constants.DestinationKind, uppercaseEscColNames bool) string {
	columnsToTypes.EscapeName(&sql.NameArgs{
		Escape:           true,
		DestKind:         destKind,
		UppercaseEscName: uppercaseEscColNames,
	})
