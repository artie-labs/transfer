...
//counterfeiter:generate -o=sql_destination.mock.go ../destination SQLDestination
...
//counterfeiter:generate -fake-name=FakeMetricsClient -o=metrics_client.mock.go ../telemetry/metrics/base Client
