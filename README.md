...
| kafka.topicConfigs[0].db | String | N | Name of the database in Snowflake, or<br/> Data set in BigQuery |
...
| bigquery | Object | Y<br/>`outputSource` dependent | This is the parent object, please see below |
